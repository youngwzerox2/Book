...
<head>
    ...
    <link rel="icon" href="/assets/imgages/favicon.ico" type="image/x-icon">
    <link rel="shortcut icon" href="/assets/imgages/favicon.ico" type="image/x-icon">
                ...
                <div class="header-menu">
                    ...
                    <div class="user-area dropdown float-right">
                        <a href="#" class="dropdown-toggle active" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false">
                            <img class="user-avatar rounded-circle" src="images/costume8.png" alt="User Avatar">
                        </a>

                        <div class="user-menu dropdown-menu">
                            <a class="nav-link" href="#"><i class="fa fa-power -off"></i>로그아웃</a>
                        </div>
                    </div>
