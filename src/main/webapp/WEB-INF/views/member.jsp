                        ...
                        <div class="card">
                            ...
                            <div class="card-body">
                                <table id="bootstrap-data-table"
                                    class="table table-striped table-bordered" style="background-color: rgb(167, 150, 230);">
                                    <thead style="background-color: rgb(162, 25, 216);">
                                        <tr>
                                            <th>아이디</th>
                                            <th>이름</th>
                                            <th>이메일</th>
                                    ...
                                    <tbody>
                                        <c:forEach items="${memberList}" var="member">
                                            <tr>
                                                <td><a href="memberDetail?memberId=${member.memberId}">${member.memberId}</a></td>
